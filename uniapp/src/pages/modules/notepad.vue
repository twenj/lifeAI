  ...
  <view class="notepad-page">
    ...
    <view v-if="editorVisible" class="editor-panel">
      <view class="editor-header">
        <view class="editor-title">{{ editingId ? '编辑笔记' : '新建笔记' }}</view>
...
.editor-content-input { min-height: 220rpx; max-height: 480rpx; margin-top: 18rpx; padding: 18rpx 20rpx; line-height: 1.5; }
